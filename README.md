...
- Создайте базу командами `python3 manage.py makemigrations` и `python3 manage.py migrate` 
- Создайте суперпользователя командой `python3 manage.py createsuperuser`
- Запустите сервер командой `python3 manage.py runserver`
- Войдите под учётной записью суперпользователя `127.0.0.1:8000/admin`
- Добавьте покемонов
